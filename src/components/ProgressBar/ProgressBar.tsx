...
export default function ProgressBar ({ value, maxValue = 100 }: ProgressBarProps) {
  ...
  return (
    <div style={{ width: '100%', height: '15px', backgroundColor: '#ccc', borderRadius: '4px', overflow: 'hidden' }}>
      <div
        style={{
